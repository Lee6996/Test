            ...
            try
            {
                if (!string.IsNullOrEmpty(txtCode.Text) && !string.IsNullOrEmpty(txtName.Text) && !string.IsNullOrEmpty(cbType.Text))
                {
                    ...
                    Item_MasterVO item = new Item_MasterVO()
                    {
                        ...
                        Level_1 = cbLevel1.SelectedIndex.ToString().Trim(),
                        Level_2 = cbLevel2.SelectedIndex.ToString().Trim(),
                        Level_3 = cbLevel3.SelectedIndex.ToString().Trim(),
                        Level_4 = cbLevel4.SelectedIndex.ToString().Trim(),
                        Level_5 = cbLevel5.SelectedIndex.ToString().Trim(),
